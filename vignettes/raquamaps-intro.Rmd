...
output:
  html_document:
    ...
    highlight: default
vignette: >
  %\VignetteIndexEntry{raquamaps-intro}
...
ggplot(probs, aes(x = prod_p)) + theme_raquamaps() +
...
Due to curl requests for aquamaps.org timeing out on the travis-ci.org for the automatic build, the R code below is not executed when building this vignette.

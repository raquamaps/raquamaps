---
title: "Introduction to raquamaps"
...
This vignette is a long form documentation included in the raquamaps to describe some common usage scenarios. 
...
## Get presence data for a given species

Using the built-in reference dataset you can get some presence data to work with like this:

-- TODO

Using rgbif you can get reference data for any species like so:

-- TODO

You can visualize this presence data in raster formal like so:

-- TODO

## Calculate distribution probabilities

Now that we have the presence data for one species, we can calculate the environmental envelope or spread values.

-- TODO

For the whole half degree cells grid we can then calculate probabilites for presence:

--TODO

## Restrict output to areas with known presence

-- TODO write this

## Loading reference data

Here we start to load some reference data
...
## Getting data using rgbif and taxize

Instead of using the prepackaged reference data, you will probably want to get data from GBIF. Here is an illustration of how to do this.

```{r, echo=TRUE}
# use taxize and rgbif to load presence data
